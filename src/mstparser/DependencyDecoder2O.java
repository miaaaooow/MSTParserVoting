...
public class DependencyDecoder2O extends DependencyDecoder {
	...
	public Object[][] decodeProjective(DependencyInstance inst,
		...
		KBestParseForest2O pf = new KBestParseForest2O(0, forms.length - 1,
				inst, K);
				...
				for (int r = s; r < t; r++) {
					...
					if (!(b1 == null || c1 == null)) {
						...
						for (int k = 0; k < pairs.length; k++) {
							...
							pf.add(s, r, t, -1, 0, 2, bc, new FeatureVector(),
									b1[comp1], c1[comp2]);
							pf.add(s, r, t, -1, 1, 2, bc, new FeatureVector(),
									b1[comp1], c1[comp2]);
						}
					}
				}
