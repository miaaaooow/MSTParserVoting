...
public class Parameters {
	...
	public void updateParamsMIRA(DependencyInstance inst, Object[][] d, double updateFactor) {
		...
		for (int k = 0; k < K; k++) {
			...
			for (FeatureVector curr = fv; curr.index >= 0; curr = curr.next) {
				...
				total[curr.index] += updateFactor * alpha[k] * curr.value;
			}
		}
	...
	public double numErrorsLabel(DependencyInstance inst, String pred,
			String act) {
